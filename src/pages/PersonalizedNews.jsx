    ...
    <main className="min-h-screen bg-[#07080d] text-white">
      <div className="mx-auto max-w-7xl px-4 pb-14 pt-6 sm:px-6 lg:px-8">
        ...
        <section className="mb-10 grid gap-6 lg:grid-cols-[1.35fr_0.85fr]">
          ...
          <div className="rounded-[2rem] border border-violet-400/20 bg-white/[0.03] p-5 shadow-[0_0_0_1px_rgba(168,85,247,0.05)] backdrop-blur-sm sm:p-6">
            ...
            <div className="mt-5 rounded-[1.5rem] border border-violet-400/20 bg-gradient-to-br from-violet-500/12 via-fuchsia-500/10 to-transparent p-4">
              <p className="mb-3 text-[10px] font-medium uppercase tracking-[0.14em] text-violet-100">
                {selectedStory?.category || "Story spotlight"}
              </p>
              <h3 className="text-xl font-medium tracking-[-0.04em] text-zinc-50">
                {selectedStory?.title || "Select a story to begin"}
              </h3>
              <p className="mt-3 text-sm leading-6 text-zinc-300">
                {selectedStory?.description || "Choose a news story from the feed to start the briefing."}
              </p>
            </div>
          </div>
        </section>
